...
[MDX](https://mdxjs.com/)는 마크다운 파일에 바로 [JSX](https://react.dev/learn/writing-markup-with-jsx)를 작성할 수 있게 하는 마크다운의 초 집합입니다. MDX는 역동적인 상호작용 능력을 추가하고 리액트 컴포넌트를 콘텐츠에 포함할 수 있는 강력한 방법입니다.
...
## [심층 분석: 어떻게 마크다운을 HTML로 변형시킬 수 있나요?](#deep-dive-how-do-you-transform-markdown-into-html)
