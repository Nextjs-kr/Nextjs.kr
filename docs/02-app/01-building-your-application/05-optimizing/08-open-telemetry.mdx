---
제목: OpenTelemetry
내용: OpenTelemetry로 Next.js 앱을 다루는 법 배우기
---

> **참고**: 이 기능은 **실험 단계**에 있습니다. you need to explicitly opt-in by providing `experimental.instrumentationHook = true;` in your `next.config.js`.

Observability is crucial for understanding and optimizing the behavior and performance of your Next.js app.

애플리케이션이 복잡해질 수록, 발생할 수 있는 이슈를 진단하고 정의하는 것은 점점 더 어려워집니다. By leveraging observability tools, such as logging and metrics, developers can gain insights into their application's behavior and identify areas for optimization. With observability, developers can proactively address issues before they become major problems and provide a better user experience. Therefore, it is highly recommended to use observability in your Next.js applications to improve performance, optimize resources, and enhance user experience.

앱을 관리하기 위해 OpenTelemetry를 사용하는 것을 권장합니다.
...
OpenTelemetry를 활성화하면 `getStaticProps`와 같이 다른 유용한 속성들과 함께 *spans*로 모든 코드를 자동으로 감싸주게 됩니다.

> **참고**: 현재 OpenTelemetry bindings는 서버리스 함수에서만 지원됩니다.
...
시작에 앞서, 먼저 `@vercel/otel`를 설치해야 합니다.
