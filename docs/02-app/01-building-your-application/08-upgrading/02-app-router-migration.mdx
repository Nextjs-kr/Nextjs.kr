...
> **참고**: ESLint 변경 사항을 적용하기 위해 VS Code에서 ESLint 서버를 다시 시작해야 할 수 있습니다. 그 때 Command Palette (`cmd+shift+p` on Mac; `ctrl+shift+p` on Windows)를 열고 `ESLint: Restart ESLint Server`를 검색하세요.
