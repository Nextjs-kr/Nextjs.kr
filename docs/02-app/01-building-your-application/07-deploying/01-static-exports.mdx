...
Next.js가 이러한 정적 내보내기를 지원하므로 HTML/CSS/JS 정적 자원을 제공할 수 있는 모든 웹 서버에 배포하고 호스팅할 수 있습니다.
...
정적 내보내기를 통해 Next.js는 HTML/CSS/JS 정적 자원을 제공하는 모든 웹 서버에 배포하고 호스팅할 수 있습니다.
