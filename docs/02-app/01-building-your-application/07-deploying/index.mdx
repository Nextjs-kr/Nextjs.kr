...
Next.js는 [도커](https://www.docker.com/) 컨테이너를 지원하는 모든 호스팅 서비스를 통해 배포할 수 있습니다. 이 방식을 사용하여 [Kubernetes](https://kubernetes.io/), [HashiCorp Nomad](https://www.nomadproject.io/) 같은 컨테이너 오케스트레이터, 또는 모든 클라우드 서비스에서 싱글 노드로 실행하고 있을 때에도 배포할 수 있습니다.
