...
React 18과 Next.js 13는 애플리케이션을 렌더링하는 새로운 방법을 소개했습니다. 이 페이지에서는 렌더링 환경, 전략, 런타임의 차이점과 그것들을 어떻게 선택하는지에 대해 이해할 수 있도록 도와줄 것입니다.
...
> **Good to know**: 서버는 애플리케이션이 배포된 지역의 컴퓨터, 애플리케이션 코드가 분산되는 [Edge Network](https://vercel.com/docs/concepts/edge-network/overview) 또는 렌더링 작업의 결과가 캐싱될 수 있는 [Content Delivery Networks (CDNs)](https://developer.mozilla.org/en-US/docs/Glossary/CDN)를 의미할 수 있습니다.
...
> **Good to know**: 이는 [Static Site Generation (SSG)](/docs/pages/building-your-application/rendering/static-site-generation)과 [Incremental Static Regeneration (ISR)](/docs/pages/building-your-application/rendering/incremental-static-regeneration)이 [Pages Router](/docs/pages/building-your-application/rendering)에서 하는 것과 동일합니다.
...
> **Good to know**: 이는 [Pages Router](/docs/pages/building-your-application/rendering)에서의 [Server-Side Rendering (`getServerSideProps()`)](/docs/pages/building-your-application/rendering/server-side-rendering)과 동일합니다.
