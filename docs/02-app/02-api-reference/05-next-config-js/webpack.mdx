...
Next.js에서 웹팩 설정을 개발자의 의도에 따라 다양하게 바꾸는 방법에 대해 알아봅니다.
---

> **알아두기**: 웹팩 설정에 대한 변경은 [유의적 버전 명세](https://semver.org/lang/ko/)에 포함되지 않으므로, 이와 관련된 부분은 개발자가 직접 스스로 책임지고 관리하도록 합니다.
