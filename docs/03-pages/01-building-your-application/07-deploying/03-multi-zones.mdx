...
- 서빙을 위한 하나의 애플리케이션 `/blog/**`
- 이외의 모든 페이지를 전송하기 위한 모든 애플리케이션

멀티 존(다중 영역)이 적용된다면, 각각의 애플리케이션들을 독립적으로 개발 및 배포할 수 있으며, 고객들이 하나의 주소로 접근할 수 있는, 하나의 애플리케이션으로 애플리케이션들을 병합할 수 있습니다.
