...
[Vercel](https://vercel.com?utm_source=next-site&utm_medium=docs&utm_campaign=next-website)은 단 하나의 설정 없이도 Next.js 어플리케이션을 배포할 수 있는 가장 즉각적인 방법입니다.
...
- 무한으로 확장 할 수 있는 독립된 [서버리스 함수](https://vercel.com/features/infrastructure?utm_source=next-site&utm_medium=docs&utm_campaign=next-website)로 [API 라우터](/docs/pages/building-your-application/routing/api-routes)를 자동 최적화
- [미들웨어](/docs/pages/building-your-application/routing/middleware)는 cold start가 전혀 없고, 즉시 부팅되는 [Edge Functions](https://vercel.com/features/edge-functions?utm_source=next-site&utm_medium=docs&utm_campaign=next-website)을 통해 자동 최적화
