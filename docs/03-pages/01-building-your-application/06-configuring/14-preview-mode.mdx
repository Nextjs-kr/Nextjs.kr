...
[페이지 문서](/docs/pages/building-your-application/routing/pages-and-layouts)과 [데이터 가져오기](/docs/pages/building-your-application/data-fetching)에서, `getStaticProps`과 `getStaticPaths`를 사용하여 페이지를 빌드 타임에 미리 렌더링(**정적 생성**)하는 방법에 대해 다뤘습니다.
