...
```
Next.js는 격리된 scope의 CSS를 지원하기 위해 [styled-jsx](https://github.com/vercel/styled-jsx)를 번들로 제공합니다. 목표는 [서버 렌더링을 지원하지 않고 JS 전용](https://github.com/w3c/webcomponents/issues/71)인 Web 컴포넌트와 비슷한 "shadow CSS"를 지원하는 것입니다. 
