...
- [GitHub Reactionse 데모](https://reactions-demo.vercel.app/)
...
- 페이지가 성공적으로 생성되면 Next.js는 캐시를 무효화하고 업데이트된 페이지를 표시합니다. 만약 백그라운드 재생성이 실패하면 이전 페이지는 여전히 변경되지 않은 채로 남아 있습니다.
