---
제목: 자동 정적 최적화
설명: Next.js는 가능할 때마다 앱을 정적 HTML로 자동 최적화합니다. 여기에서 작동 방식을 알아보세요.
---
...
> **알아두면 좋은 정보**: [동적라우팅](/docs/pages/building-your-application/routing/dynamic-routes)를 사용하는 페이지에 [`getStaticProps`](/docs/pages/building-your-application/data-fetching/get-static-props)로 추가된 매개변수는 항상 `query` 개체 내에서 사용할 수 있습니다.
